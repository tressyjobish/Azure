        ...
        <div className="discover-container">
          ...
          <div className="discover-card">
            <div className="discover-info">
              ...
              <p>
                Learn how Microsoft works with the<br></br> open-source community to develop<br></br> new technologies-
                watch live or on<br></br>demand.
              </p>
            </div>
            <div className="discover-info">
              <img src={dot} />
            ...
            <div>
              <div className="dicover-rowcard2">
                <div className="discover-rowcardtext">
                 <div className="discovertext"> <p>Go beyound the limits of on-premises datacentres</p>  
                   <p>with more regions than any other provider</p></div>
